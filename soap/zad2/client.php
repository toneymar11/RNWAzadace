<?php
  ...
  ini_set('soap.wsdl_cache_ttl',0);
    ...
    $sClient = new SoapClient('http://localhost/soap/zad2/wsdl/territories.wsdl',
              array('cache_wsdl'=>WSDL_CACHE_NONE,'trace' => 1)
              );
    $response = $sClient->listEmployees($id);
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="territories.css">
  <style>
    #id {
        width: 100%;
        padding: 10px 10px;
...
<body>
    ...
    <p>Upisite TerritoryDescription: </p>  
    <form id="form" action="./client.php" method="post">
    <input type="text" id="id" name="id" placeholder="TerritoryDescription">  
    <div id="err"></div>
